    ...
    let litag = `<li class="note">
                            ...
                            <div class="bottom-content">
                                ...
                                <div class="settings" id="mydiv">
                                    ...
                                    <ul class="menu">
                                        <li onclick="editNote(${index},'${note.title}','${note.description}')"><img src="editing.png" alt="Girl in a jacket">Edit</li>
                                        <li onclick="deleteNote(${index})"><img src="garbage.png" alt="Girl in a jacket">    Delete</li>
                                    </ul>
                                </div>
                            </div>
                     </li>`;
...
addBtn.onclick = (e) => {
  ...
  let ti = titleTag.value+1;
  let desc = descTag.value+1;
